    ...
    options: {
        ...
        updateFeature: function(feature, oldLayer) {
			...
			if (feature.geometry.type === 'Point') {
				...
				if (feature.geometry.properties === 'red') {
					oldLayer.setIcon(red);
				}
				else if(feature.geometry.properties === 'bmkg'){
					oldLayer.setIcon(bmkg);
				}else if(feature.geometry.properties === 'wrs'){
					oldLayer.setIcon(wrs);
				}else if(feature.geometry.properties === 'tidegauge'){
					oldLayer.setIcon(tidegauge);
				}else if(feature.geometry.properties === 'green'){
					oldLayer.setIcon(green);
				}else if(feature.geometry.properties === 'orange'){
