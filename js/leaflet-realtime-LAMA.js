    ...
    options: {
        ...
        updateFeature: function(f, oldLayer) {
            ...
            if (f.geometry.type === 'Point') {
				...
				if (f.geometry.properties === 'red') {
					oldLayer.setIcon(red);
				}
				else if(f.geometry.properties === 'acc'){
					oldLayer.setIcon(bmkg);
				}else if(f.geometry.properties === 'int'){
					oldLayer.setIcon(wrs);
				}else if(f.geometry.properties === 'tidegauge'){
					oldLayer.setIcon(tidegauge);
				}else if(f.geometry.properties === 'no'){
					oldLayer.setIcon(no);
					//oldLayer.popup.setContent("aku berubah");
				}else if(f.geometry.properties === 'green'){
					oldLayer.setIcon(green);
				}else if(f.geometry.properties === 'orange'){
					oldLayer.setIcon(orange);
				}else{
					oldLayer.setIcon(off);
				}
